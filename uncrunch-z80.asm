...
;
; Please note that, beyond an overall understanding of what Huffman and
;   LZ compression are, I have no idea what's going on here!
;
; This decompressor is 392 bytes long and is a straight conversion from
;   the GB-Z80 code, with quite a few optimisations to save bytes here
;   and there. It may be possible to make it smaller and/or faster. If
;   you do, please let me know! If using it as a decompressor stub then
;   you might be able to optimise calls into rsts, but you'll have to
;   also define some framework for handling the normal interrupt vectors
;   too. Heliophobe's CallHL trick works well for that kind of thing.
;
;
; To do:
; - maybe make it optionally output to VRAM, for use with compressed
;   VDP data
